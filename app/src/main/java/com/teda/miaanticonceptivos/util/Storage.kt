...
object Storage {
    ...
    var methods = arrayListOf(
            ...
            Method(5, "Implante", 36, 2, R.drawable.implante),
            Method(6, "Inyectables", 3, 1, R.drawable.inyectables_res),
    ...
    var compareList = arrayListOf(
            ...
            arrayListOf(3, 3, 3, 2, 0, 1, 1, 1, 0, 3),
            arrayListOf(0, 0, 0, 3, 3, 2, 2, 2, 2, 0),
            arrayListOf(0, 0, 0, 2, 2, 2, 2, 2, 2, 0),
            arrayListOf(3, 0, 3, 2, 2, 2, 2, 2, 2, 0),
            arrayListOf(0, 0, 0, 0, 0, 0, 0, 0, 0, 3),
            arrayListOf(3, 3, 3, 2, 2, 1, 1, 1, 1, 1),
            arrayListOf(3, 3, 3, 3, 3, 1, 1, 1, 1, 1),
            arrayListOf(3, 3, 3, 3, 2, 2, 1, 1, 2, 1)
    )
